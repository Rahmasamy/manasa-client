...
export default function BoxComponent({
  ...
  return (
    <div className='border-2 border-[#2885AC] rounded-xl p-5 bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#2885AC]/80'>
       <div className='flex gap-3 items-start'>
          <div className='flex-shrink-0 mt-1'>
            {icon}
          </div>
          <div className='flex-1'>
            <h2 className='font-bold py-2 text-lg text-gray-800'>
                {title}
            </h2>
